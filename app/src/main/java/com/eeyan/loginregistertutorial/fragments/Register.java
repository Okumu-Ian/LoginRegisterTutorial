...
public class Register extends Fragment {
    ...
    private View mView;
    private TextInputEditText email,password_confirm,password;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        password_confirm = mView.findViewById(R.id.edt_register_password);
        password = mView.findViewById(R.id.edt_register_password_confirm);
    ...
    private void checkCredentials(){
        ...
        String user_password_confirm = password_confirm.getText().toString();
    ...
    private void registerUSER(final String sample_email, final String sample_password){
